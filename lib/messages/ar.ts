const messages: Record<string, string> = {
  ...
  'subs.synced.important':
    'Wyzie Synced **ميزة Pro**: تحصل المفاتيح المجانية على 403 Paid feature. تكلف كل مزامنة ناجحة **1 طلب**؛ ولا تُحتسب المزامنة التي لا تجد تطابقاً. بعد ذلك يُحتسب تنزيل الرابط المُزامَن مثل أي تنزيل آخر.',
  'subs.synced.p1':
  ...
  'subs.synced.api.p':
    'أرسل الترجمة التي تريدها (رابط تنزيل، أو العنوان ليختار Wyzie أفضل تطابق) والصوت: إما توقيتات الكلام التي اكتشفتها بنفسك، أو ملف الصوت/الفيديو نفسه.',
  ...
  'subs.synced.error.429':
    'لا يستطيع المفتاح دفع تكلفة الطلب، كما في أي استدعاء آخر.',
