const messages: Record<string, string> = {
  ...
  'subs.intro.note.ai':
    'AI-переклад доступний для Pro-ключів. Будь-яка назва, 80+ цільових мов, потокова передача в порядку субтитрів, щойно готовий черговий пакет.',
  ...
  'subs.translate.important':
    'AI-переклад — це **Pro-функція**; безкоштовні ключі отримують 403 Upgrade required. Кожен виклик коштує **100 запитів** з балансу вашого ключа, включно з попаданнями в кеш. Якщо виклик завершується помилкою ще до появи будь-яких вихідних даних (субтитри не знайдено, збій пошуку чи завантаження або сервер зайнятий), 100 запитів автоматично повертаються.',
  'subs.translate.p1':
  ...
  'subs.translate.limit1':
    'AI-перекладу потрібні текстові субтитри як основа. Джерела у форматах VTT, ASS, SSA і SUB спершу конвертуються в SRT; якщо текстових субтитрів немає, виклик завершується помилкою 404 No subtitle found, а 100 запитів повертаються.',
  ...
  'subs.translate.limit4':
    'Переклади тарифікуються і при попаданні в кеш. Незалежно від того, згенеровано переклад заново чи взято з 30-денного кешу, кожен виклик /translate коштує 100 запитів. Запити повертаються лише за виклики, що завершилися помилкою ще до появи будь-яких вихідних даних.',

  // Subs Synced Page
  'subs.synced.title': 'Wyzie Synced',
  'subs.synced.important':
    'Wyzie Synced є **Pro-функцією**: безкоштовні ключі отримують 403 Paid feature. Кожна успішна синхронізація коштує **1 запит**; синхронізація, яка не знайшла збігу, не тарифікується. Завантаження за синхронізованим посиланням далі тарифікується як будь-яке інше завантаження.',
  'subs.synced.p1':
  ...
  'subs.synced.api.p':
    'Передайте, які субтитри вам потрібні (посилання для завантаження або назву, щоб Wyzie сам вибрав найкращий збіг), і звук: або таймінги мовлення, які ви визначили самостійно, або сам аудіо- чи відеофайл.',
  ...
  'subs.synced.error.429':
    'Ключ не може оплатити запит, як і у випадку будь-якого іншого виклику.',
  ...
  'subs.keys.limit.p':
    'Пошук коштує 1 запит, завантаження кожного файлу субтитрів теж коштує 1 запит, тож один пошук і завантаження одного файлу витрачають 2 запити. AI-переклад коштує 100 запитів за виклик.',
