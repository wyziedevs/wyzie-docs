...
Visit [sub.wyzie.io/redeem](https://sub.wyzie.io/redeem) to claim a free developer API key. You'll need to complete a quick verification (Cloudflare Turnstile) and you'll receive your key instantly.
...
Visit [sub.wyzie.io/redeem](https://sub.wyzie.io/redeem) again. Keys are linked to your device, so you may receive the same key if you're on the same browser.
