...
<Important>
  An API key is required for all requests. Get your free key at [sub.wyzie.io/redeem](https://sub.wyzie.io/redeem) and pass it via the `key` parameter. See the [API Keys](api-keys) page for details.
</Important>
...
| **key**         | key               | Your API key _(required)_. Get one free at [sub.wyzie.io/redeem](https://sub.wyzie.io/redeem).  |
