...
<Tabs items={["Response", "Requests"]}>
  ...
  <Tabs.Tab>
    ```
    https://sub.wyzie.io/search?id=286217
    https://sub.wyzie.io/search?id=tt3659388
    https://sub.wyzie.io/search?id=tt0121955&season=1&episode=1
    https://sub.wyzie.io/search?id=tt3659388&language=en
    https://sub.wyzie.io/search?id=tt3659388&format=srt
    https://sub.wyzie.io/search?id=tt3659388&source=subdl
    ```
  </Tabs.Tab>
</Tabs>
