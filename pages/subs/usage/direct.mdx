...
<Important>
  An API key is required for all requests. Get your free key at [sub.wyzie.io/redeem](https://sub.wyzie.io/redeem) and include it as `&key=YOUR_KEY` in every request. See the [API Keys](api-keys) page for details.
</Important>
...
| **key**              | `/search?id=tt3659388&key=YOUR_KEY`                   | Your API key _(required)_. Get one free at [sub.wyzie.io/redeem](https://sub.wyzie.io/redeem).           |
